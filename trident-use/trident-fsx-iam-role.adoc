...
----
Pour plus d'informations, veuillez consulterlink:https://docs.aws.amazon.com/eks/latest/userguide/pod-id-agent-setup.html["Configurer l'agent d'identité du pod Amazon EKS"] .
