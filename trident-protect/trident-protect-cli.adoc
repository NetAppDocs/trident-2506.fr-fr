...
summary: Vous pouvez utiliser la commande protectctl pour créer et interagir avec des ressources personnalisées de protection Trident . 
---
...
[role="lead"]
Vous pouvez utiliser le plugin de ligne de commande Trident Protect, qui est une extension de Trident. `tridentctl` utilitaire, pour créer et interagir avec les ressources personnalisées Trident Protect (CR).
