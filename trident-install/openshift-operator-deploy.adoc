...
---
= Installer Trident à l'aide d'OpenShift OperatorHub
:hardbreaks:
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Si vous utilisez Red Hat OpenShift, vous pouvez installer NetApp Trident à l'aide de l'opérateur certifié Red Hat.  Utilisez cette procédure pour installer Trident à partir de la plateforme de conteneurs Red Hat OpenShift.
...
. Sélectionnez cette option si vous souhaitez supprimer toutes les instances d'opérande de l'opérateur.
+
